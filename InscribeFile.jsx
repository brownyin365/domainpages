        ...
        <div class="min-h-screen bg-black flex flex-col justify-center relative overflow-hidden sm:py-12 bg-gradient-to-br from-blue-500 to-pink-500">
          <div class="max-w-7xl mx-auto">
            <div class="relative group">
              ...
              <div class="relative px-7 py-6 ring-1 ring-gray-900/5 rounded-lg leading-none flex items-top justify-start space-x-6 bg-black">
                <div class="max-w-screen-xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                  <div class="max-w-3xl mx-auto lg:max-w-800">
                    <div>
                      <h1 className="text-2xl font-semibold text-white">
                        Upload your files to begin, we will inscribe for you:
                      </h1>
                    </div>
                    <br></br>
                    {/* Select Buttons */}
                    <div class="h-8 flex gap-3 content-evenly mt-6 sm:mt-5">
                      <input
                        ...
                        type="checkbox"
                        value=""
                        class="w-4 h-4 text-blue-600 bg-gray-900 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label
                        for="link-checkbox"
                      ...
                      <li>
                        <div class="px-4 py-4 sm:px-6">
                          <div class="flex items-center">
                            <button class="bg-pink-600 shadow text-white hover:bg-gray-400 font-bold  p-1 py-2 px-4 mt-3  rounded-full w-full max-w-3xl mx-auto lg:max-w-800">
                              Next
                            </button>
                          </div>
                        </div>
